...
$(document).ready(function() {
    var handleLecture = {
        openLecture: function(url){
            openLecture(url)
        },
        renderLecture: function(lectureObject){
            renderLecture(lectureObject)   
        },
        renderPage: function(pageObject){
            renderPage(pageObject)   
        }
    };
    
    var openLecture = function(url) {
